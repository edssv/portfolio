  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between">
      <div className="flex flex-col w-full items-center gap-8">
        <div className="flex flex-col w-full items-center mt-[7vh] gap-y-[7vh] px-6 xl:px-0">
        ...
        <div className="text-gray-100 bg-black w-full flex justify-center">
              ...
              <div className="grid xl:grid-cols-2 gap-4">
                <Card>
                  <div className="flex flex-col h-full justify-center">
                    <h3 className="text-4xl font-bold mb-6">Почему я полюбил программирование?</h3>
                ...
                <div className="order-1 xl:order-none px-6 xl:px-0 flex flex-col mt-6 gap-6 justify-between">
                  <SocialLinks />
                  <Link
                    target="_blank"
                ...
                <Card>
                  <h3 className="text-4xl font-bold mb-6">5 Фактов обо мне</h3>
